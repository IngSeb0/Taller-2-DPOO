...
public class SandboxConjuntos
{
    ...
    {
    	List<String> llavesNoInvertidas = new ArrayList<>(arbolCadenas.descendingSet());
    	  llavesNoInvertidas.sort((s1, s2) -> s1.compareTo(s2));
    	  	return llavesNoInvertidas;
    }
    ...
    {
    	List<String> llavesInvertidas = new ArrayList<>(arbolCadenas.descendingSet());;
